...
(function () {
  ...
  const TOPBAR_SUPABASE_URL = 'https://pdropxqcdyppbjkaxgpo.supabase.co';
  const TOPBAR_SUPABASE_KEY = 'sb_publishable_7y8hvL8HV-X2YLHora2EKw_jhdTI7UH';
...
<header class="topbar" id="topbar" role="navigation" aria-label="System bar">
  <a href="/" class="topbar-os" aria-label="Home">
...
<nav class="bottombar" id="bottombar" role="navigation" aria-label="Sunpath areas">
  ...
  <a href="/" class="bottombar-tab" data-page="today">
    <span>Today</span>
  </a>
